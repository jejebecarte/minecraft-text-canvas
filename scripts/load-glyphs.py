...
for i in range(2):
    ...
    font.ascent = 10 if is_regular else 40
    font.descent = 2 if is_regular else 8
    font.uwidth = 0
    ...
    space.width = 4 if is_regular else 16

    # TODO: Do characters ?{/ have padding before, and .\ after?
